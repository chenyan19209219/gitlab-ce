  ...
  class Variables < Grape::API
    ...
    resource :projects, requirements: API::NAMESPACE_OR_PROJECT_REQUIREMENTS do
      ...
      params do
        ...
        optional :variable_type, type: String, desc: 'The type of variable, must be one of env_var or file. Defaults to env_var'
      ...
      params do
        ...
        optional :protected, type: String, desc: 'Whether the variable is protected'
        optional :variable_type, type: String, desc: 'The type of variable, must be one of env_var or file'

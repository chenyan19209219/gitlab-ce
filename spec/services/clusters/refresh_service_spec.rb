...
describe Clusters::RefreshService do
  ...
  describe '#create_or_update_namespaces_for_project' do
    ...
    context 'project belongs to a group cluster' do
      ...
      context 'when project has a kubernetes namespace from a previous group' do
        ...
        xit 'destroys the old kubernetes namespace' do
          expect { subject }.to change { old_group_cluster.kubernetes_namespaces.count }.by(-1)
        end
      end
    end
  end

...
class Project < ApplicationRecord
  ...
  has_one :metrics_dashboard_setting, inverse_of: :project, class_name: 'ProjectMetricsDashboardSetting'
  ...
  accepts_nested_attributes_for :metrics_dashboard_setting, update_only: true
